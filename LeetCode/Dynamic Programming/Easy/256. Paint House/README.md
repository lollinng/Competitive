Q. here are a row of n houses, each house can be painted with one of red,blue,green colors. The cost of painting each house with a certain color is different.
